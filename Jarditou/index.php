                ...
                <div class="col-md-6 col-lg-8">
                    ...
                    <section class="ml-3">
                        ...
                        <article>
                            ...
                            Vous souhaitez un devis ? Nous vous le réalisons gratuitement. Lorem ipsum dolor sit amet, consectetur adipiscing elit, 
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Non tellus orci ac auctor augue mauris augue. 
                            Quis vel eros donec ac odio. Dignissim suspendisse in est ante in nibh mauris. Cursus risus at ultrices mi.</p>
                        </article>
                    </section>
                </div>
                <div class="col-md-6 col-lg-4 bg-warning pr-3">
                    <p class="text-dark text-center">[Colonne de droite]</p>
                </div>
            </div>			
        </div>
        <br>		
